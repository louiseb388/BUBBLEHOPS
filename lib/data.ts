...
export const BASES_IN_STOCK: BaseTrainer[] = [
  ...
  {
    id: 'advantage2',
    img: '/photos/bubblehops-adidas-advantage-2-kids-trainer-base.jpg',
    name: 'Adidas Advantage 2',
...
export const SEED_STOCK: Record<string, Record<string, number>> = {
  ...
  advantage2: { 'UK 10': 3, 'UK 11': 2, 'UK 12': 2, 'UK 13': 1, 'UK 1': 4, 'UK 2': 2, 'UK 3': 1, 'UK 4': 0, 'UK 5': 0, 'UK 6': 0 },
...
export const ROUTES: Record<string, RouteMeta> = {
  ...
  shop: { path: '/base-trainers', title: 'Base Trainers for Customising | BUBBLEHOPS', desc: "Every base trainer we hand-paint: Kappa La Morra, Adidas Advantage, Adidas Advantage 2, Adidas VS Pace and Court Borough Mid 2. UK kids' sizes 10 to 6.", crumb: 'Base trainers' },
